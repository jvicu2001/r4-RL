...
class GameInfo(_message.Message):
    ...
    class CarInfo(_message.Message):
        __slots__ = ("x_pos", "y_pos", "z_pos", "applied_direction", "intended_direction", "speed", "rpm", "gear", "gear_timeout", "accel_lifted_timer", "collided", "traction_loss_fl", "traction_loss_fr", "traction_loss_rl", "traction_loss_rr", "wrong_way", "free_fall", "drift_timeout")
    ...
    class TrackInfo(_message.Message):
        __slots__ = ("track_id", "track_status", "lap_progress", "track_progress", "lap")
        ...
        track_progress: int
        lap: int
        def __init__(self, track_id: _Optional[int] = ..., track_status: _Optional[int] = ..., lap_progress: _Optional[int] = ..., track_progress: _Optional[int] = ..., lap: _Optional[int] = ...) -> None: ...
